...
class Darknet(nn.Module):
    ...
    def forward(self, x, CUDA):
        ...
        for i, module in enumerate(modules):        
            ...
            if module_type == "convolutional" or module_type == "upsample":
                ...
                x = self.predict_transform(x, inp_dim, anchors, num_classes, CUDA) #, self.class_selector)
    ...
    def predict_transform(self,prediction, inp_dim, anchors, num_classes, CUDA = True):#, class_selector=None):
